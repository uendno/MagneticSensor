package com.thangtv.magneticsensor;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private class ExportToCSVTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(MainActivity.this, "Saving..,", " Please wait.", true);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            if (var) {
                ...
                filename = folder.toString() + "/magnetic_sensor_" + date.getTime() + ".csv";
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(MainActivity.this, "Saved in " + filename, Toast.LENGTH_SHORT).show();
        }
